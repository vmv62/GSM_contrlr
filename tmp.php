...
<html lang="ru">
 ...
 <body> <table width="800" align="center"> 
  ...
  <table border="0" bordercolor="cc215a" width="790" height="100"
 cellpadding="10">
  <tr> 
  <th> 
  <h1><font color="cc215a" face="Monotype Corsiva">
 Название сайта (организации)</font> 
  <h3 align="left"> 
  <font color="cc215a"><font size=+2>Описание сайта,
  адрес и телефон организации</font></font> 
   </h3> 
   </h1> 
   </th> 
   </tr> 
         ...
         Здесь «разжеваны» все мелочи сопровождающие создание сайта,
          мимо которых обычно проскакивают другие авторы.
           Если вам что-то будет непонятно, спрашивайте,
            для меня нет «глупых» вопросов.</p> 
        <p>Читайте и создавайте свой сайт самостоятельно, 
            каким бы ни был Ваш возраст и стаж работы на компьютере.
             Уверен, у Вас получится еще лучше и уж точно,
              в несколько раз быстрее, чем у меня.</p> 
               </td> 
               <!--Сайдбар--> 
              ...
              Другая страница</p> 
               ...
               <p align="left">Текст дополнительной информации</p> 
               </td> 
               </td> 
               </tr> 
               </tr> 
